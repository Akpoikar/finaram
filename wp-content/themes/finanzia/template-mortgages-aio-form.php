<?php
/**
 * Template name: Mortgages all-in-one form
 */
$fields        = get_fields();
                        ...
                        <div class="big-form__add-section">
                            ...
                            <div class="big-form__fields">
                                ...
                                <div class="big-form__col">
                                    ...
                                    <input class="optional" placeholder="<?php _e("Enter your maiden name", 'finanzia'); ?>"
 ...
 */ ?>
                            <div class="big-form__row">
                                <div class="big-form__three-select">
                                    ...
                                    <div class="big-form__select-col select-big">
                                        ...
                                        <input class="optional" placeholder="<?php _e("Enter the number of children", 'finanzia'); ?>"
                                               type="text"
                                ...
                                <div class="big-form__fields">
                                    <div class="big-form__col">
                                        ...
                                        <input required placeholder="<?php _e("Enter your house number", 'finanzia'); ?>"
                                               type="text"
                                               name="step_aio[main_applicant][permanent_address][house_number]" value="">
                                    </div>
                                    <div class="big-form__col">
                                        <div class="contacts__label">
                              ...
                              <div class="big-form__fields big-form__fields-difference">
                                  <div class="big-form__col">
                                      ...
                                      <input placeholder="<?php _e("Enter your city", 'finanzia'); ?>"
                                             type="text"
                                             name="step_aio[main_applicant][permanent_address_abroad][city]" value="">
                                  </div>
                                  <div class="big-form__col">
                                      <div class="contacts__label">
                                          <?php _e("Street", 'finanzia'); ?>
                                      ...
                                      <input placeholder="<?php _e("Enter your street", 'finanzia'); ?>"
                                             type="text"
                                             name="step_aio[main_applicant][permanent_address_abroad][street]" value="">
                                  </div>
                              </div>
                              <div class="big-form__fields">
                                  <div class="big-form__col">
                              ...
                              <div class="big-form__address-top">
                                ...
                                <div class="big-form__fields big-form__fields-difference">
                                    ...
                                    <div class="big-form__col">
                                        ...
                                        <input required placeholder="<?php _e("Enter your street", 'finanzia'); ?>"
                                               type="text"
                                               name="step_aio[second_applicant][permanent_address][street]" value="">
                                    </div>
                                </div>
                                <div class="big-form__fields">
                                    <div class="big-form__col">
                                ...
                                <div class="big-form__variant-list">
                                    <label class="big-form__var-1">
                                        <input id="yes" checked="checked" type="radio"
                                               name="step_aio[main_applicant][own_property]"
                                               value="yes">
                                        <span class="big-form__var-name"><?php _e("Yes", 'finanzia'); ?></span>
                                    </label>
                                    <label class="big-form__var-2">
                                        <input id="no" type="radio"
                                               name="step_aio[main_applicant][own_property]" value="no">
                    ...
                    <div class="big-form__step-5">
                        ...
                        <div class="big-form__variant other-var">
                            <div class="big-form__label">
                                <?php _e("Have you already selected a property?", 'finanzia'); ?>
                            </div>
                            <div class="big-form__variant-list">
                                <label class="big-form__var-1">
                                    <input id="yes-prop" checked="checked" type="radio"
                                           name="step_aio[already_selected_property]" value="yes">
                                    <span class="big-form__var-name"><?php _e("Yes", 'finanzia'); ?></span>
                                </label>
                                <label class="big-form__var-2">
                                    <input id="no-prop" type="radio" name="step_aio[already_selected_property]"
                                           value="no">
                                    <span class="big-form__var-name"><?php _e("No", 'finanzia'); ?></span>
                                </label>
                            </div>
                        </div>
                        <div class="big-form__row big-form__hide-box">
                            <div class="contacts__label">
                                <?php _e("Link to the selected property", 'finanzia'); ?>
                            </div>
                            <input required
                                   placeholder="<?php _e("Enter the full URL of the property listing", 'finanzia'); ?>"
                                   type="text" name="step_aio[url_property_listing]" value="">
                        </div>
                        ...
                        <div class="big-form__button">
                            ...
                            <button class="big-form__submit-btn"
                                    type="submit"><?php _e("SUBMIT", 'finanzia'); ?></button>
                        </div>
                    </div>
                </form>
            </div>
