<div class="mortgage-invest" id="mortgage-invest-sec">
    ...
    <?php else : ?>
        <div class="mortgage-invest__title">
            <?= ($args['title'] ?? __("Mortgage as an Investment", 'finanzia')); ?>
        </div>
    <?php endif; ?>
    <div class="mortgage-invest__text">
        <?= ($args['subtitle'] ?? __("A simple calculation of whether a mortgage or rent is more profitable for you.", 'finanzia')); ?>
    </div>
    <?php get_template_part('template-parts/part', 'mortgage-investment-calc'); ?>
</div>