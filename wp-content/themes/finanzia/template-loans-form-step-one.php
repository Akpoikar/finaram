<?php
/**
 * Template name: Loans form step one template
 */
$fields        = get_fields();
...
?>
    <div class="wrapper-form">
        <div class="form-page form-page-loans">
            ...
            <div class="form-content">
                ...
                <form class="big-form js_one_send" method="post">
                                ...
                                <div class="big-form__holder">
                                    ...
                                    <div id="big-form__tab-2" class="tab">
                                        ...
                                        <div class="big-form__row">
                                            ...
                                            <input placeholder="<?php _e("Enter 8 to 10 digit code", 'finanzia'); ?>"
                                                   type="text"
                                    ...
                                    <div id="big-form__tab-4" class="tab">
                                        ...
                                        <div class="big-form__row">
                                            ...
                                            <textarea
                                                    ...
                                                    placeholder="<?php _e("Summarize your company's services and operations", 'finanzia'); ?>"
                                                    rows="8"
                                                    cols="80"></textarea>
                                        </div>
                                        <div class="big-form__row">
                    ...
                    <div class="big-form__step-3">
                        ...
                        <?php //_e("Back", 'finanzia'); ?><!--</button>-->
                        <!--                            <button class="big-form__btn next-step"-->
                        <!--                                    type="button">-->
                        <?php //_e("next step", 'finanzia'); ?><!--</button>-->
                        <!--                        </div>-->
                        <!--                        <div class="big-form__check-box" style="margin-top: 20px;">-->
                        <!--                            <label class="big-form__check-multi">-->
                        <!--                                <input type="checkbox" name="step_one[processing_personal_data]" value="yes" required>-->
                        <!--                                <span class="big-form__check-text">-->
                        <?php //_e("By proceeding, you consent to the processing of your personal data.", 'finanzia'); ?><!--</span>-->
                        <!--                            </label>-->
                        <!--                        </div>-->
                        <div class="big-form__button">
                            <button class="prev-step" type="button"><?php _e("Back", 'finanzia'); ?></button>
                            <button class="big-form__submit-btn"
                                    type="submit"><?php _e("apply", 'finanzia'); ?></button>
                        </div>
                    </div>
                    ...
                    <!--                            </div>-->
                    <!--                            <select class="select" name="step_one[type_of_property]">-->
                    <!--                                <option selected="selected" class="custom-option-1"-->
                    <!--                                        value="Flat">-->
                    <?php //_e("Flat", 'finanzia'); ?><!--</option>-->
                    <!--                                <option value="House">-->
                    <?php //_e("House", 'finanzia'); ?><!--</option>-->
                    <!--                                <option value="Cottage">-->
                    <?php //_e("Cottage", 'finanzia'); ?><!--</option>-->
                    <!--                                <option value="Land">-->
                    <?php //_e("Land", 'finanzia'); ?><!--</option>-->
                    <!--                                <option value="Other - specify">-->
                    <?php //_e("Other - specify", 'finanzia'); ?><!--</option>-->
                    <!--                            </select>-->
                    <!--                        </div>-->
                    ...
                    <!--                                    <span class="big-form__var-name">-->
                    <?php //_e("Personal ownership", 'finanzia'); ?><!--</span>-->
                    <!--                                </label>-->
                    <!--                                <label class="big-form__var-2">-->
                    <!--                                    <input type="radio" name="step_one[property_variant]" value="Cooperative ownership">-->
                    <!--                                    <span class="big-form__var-name">-->
                    <?php //_e("Cooperative ownership", 'finanzia'); ?><!--</span>-->
                    <!--                                </label>-->
                    <!--                            </div>-->
                    <!--                        </div>-->
                    <!--                        <div class="big-form__row">-->
                    ...
                    <!--                                --><?php //_e("Additional Information (optional)", 'finanzia'); ?>
                    <!--                            </div>-->
                    <!--                            <textarea name="step_one[property_additional_information]"-->
                    <!--                                      placeholder="-->
                    <?php //_e("Your comments", 'finanzia'); ?><!--" rows="8"-->
                    <!--                                      cols="80"></textarea>-->
                    <!--                        </div>-->
                    <!--                        <div class="big-form__check-box">-->
                    <!--                            <label class="big-form__check-multi">-->
